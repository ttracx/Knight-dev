 ...
 * @returns A new array of KnightMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: KnightMessage[]): KnightMessage[] {
	const combinedApiRequests: KnightMessage[] = []
